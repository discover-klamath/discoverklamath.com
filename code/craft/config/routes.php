...
return array(
  'things-to-do/event-calendar/(?P<y>\d{4})/(?P<m>\d{1,2})/(?P<day>\d{1,2})' => 'events/day_listings',
  'things-to-do/event-calendar/event/(?P<slug>[^/]+)' => 'events/_entry',
  'lodging/category/(?<category>[^/]+)' => 'categories/index',
  'trip-ideas/news-and-features/(?<slug>[^/]+)' => 'news-and-features/_entry',
);
